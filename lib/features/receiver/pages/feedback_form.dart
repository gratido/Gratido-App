...
class _FeedbackFormPageState extends State<FeedbackFormPage> {
  ...
  // 🔥 SUBMIT: upload to Cloudinary + save in Firestore
  Future<void> _submit() async {
    ...
    try {
      ...
      for (final file in _pickedFiles) {
        const cloudName = "dha5efl8j";
        const uploadPreset = "gratido_feedback";
      ...
      // Save in Firestore (receiverFeedback)
      await FirebaseFirestore.instance.collection('receiverFeedback').add({
  ...
  // Category chips (unchanged visually)
  ...
  Future<void> _pickImages() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${_pickedFiles.length} image(s) attached')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            ...
            children: [
              ...
              Container(
                ...
                child: ConstrainedBox(
                  constraints:
                      const BoxConstraints(minHeight: 140, maxHeight: 400),
                  child: TextField(
